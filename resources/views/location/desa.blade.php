		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="box box-primary box-flat">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<form action="{{ action('LocationController@doCreateDesa') }}" method="POST" role="form">
						{{ csrf_field() }}
						<div class="box-body">
							...
							<div class="form-group">
								...
								<select name="kecamatan_id" class="form-control" id="select_kec">
							...
							<div class="form-group">
								...
								<input name="nama" type="text" class="form-control" placeholder="Nama Desa">
							</div>
						</div>
						<!-- /.box-body -->
